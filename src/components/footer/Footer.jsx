...
export function Footer({theme}) {
  return (
    <footer className="relative overflow-hidden py-8 ml-10 mr-10 bg-gray-100 dark:bg-gray-800 mt-10">
      <div className="container relative z-10 mx-auto px-4">
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            <NavLink to="/">
                <img src={(theme === "dark")? LogoLight : LogoDark} className="h-10 w-auto"/>
            </NavLink>
          </div>
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <a className="font-medium text-gray-600 dark:text-gray-400 hover:text-gray-700" href="mailto:sdc@iiserb.ac.in">
                  sdc@iiserb.ac.in
                </a>
              </li>
              <li className="p-5">
                <p className="font-medium text-gray-600 dark:text-gray-400 hover:text-gray-700">
                 SDC Room, 1st Floor Mess 3, IISER Bhopal, India 
                 </p>
              </li>
              <li className="p-1">
                <a className="font-medium text-gray-600 dark:text-gray-400 hover:text-gray-700 underline" href="https://www.linkedin.com/in/ayushman-saha/" target="_blank">
                  Created by Ayushman
                </a>
              </li>
              <li>
                <a className="font-medium text-gray-600 dark:text-gray-400 hover:text-gray-700 underline" href="https://www.linkedin.com/in/d33panshuraj/" target="_blank">
                and Deepanshu 2024
                </a>
              </li>
            </ul>
          ...
          <div className="w-auto p-8">
            <div className="-m-1.5 flex flex-wrap">
              <div className="w-auto p-1.5">
                <a href="https://www.facebook.com/profile.php?id=100087298622924" target="_blank">
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.quora.com/profile/SDC-IISER-Bhopal" target="_blank">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="14"
                      height="11"
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.instagram.com/sdc_iiserb/" target="_blank">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
              ...
              <div className="w-auto p-1.5">
                <a href="https://www.linkedin.com/in/sdc-iiserb/" target="_blank">
                  <div className="flex h-8 w-8 items-center justify-center rounded-full border border-gray-300 hover:border-gray-400">
                    <svg
                      width="16"
                      height="15"
